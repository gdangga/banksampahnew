...
=======
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
        <div class="d-flex align-items-center">
            ...
            <h2 class="fs-2 m-0 fw-bold">Dashboard Admin</h2>
        </div>
        ...
        <div class="row g-3 my-2">
            <div class="col-md-3">
                <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded-3">
                    <div>
                        <h3 class="fs-2 fw-bold"><?php echo $adminCount; ?></h3>
                        <p class="fs-5 text-muted mb-0">Admin</p>
                    </div>
...
>>>>>>> Stashed changes
            ...
            <div class="col-md-3">
                <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded-3">
                    <div>
                        <h3 class="fs-2 fw-bold"><?php echo $nasabahCount; ?></h3>
                        <p class="fs-5 text-muted mb-0">Nasabah</p>
                    </div>
            ...
            <div class="col-md-3">
                <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded-3">
                    <div>
                        <h3 class="fs-2 fw-bold"><?php echo $transaksiCount; ?></h3>
                        <p class="fs-5 text-muted mb-0">Transaksi</p>
                    </div>
            ...
            <div class="col-md-3">
                <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded-3">
                    <div>
                        <h3 class="fs-2 fw-bold"><?php echo $artikelCount; ?></h3>
                        <p class="fs-5 text-muted mb-0">Berita</p>
                    </div>
